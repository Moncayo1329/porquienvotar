    ...
    <div>
      ...
      <div className="Propuestas">
        ...
        <li className="propuestas-3">Económico</li>
          ...
          <li className="propuestas-11">Migración Ecuatoriana</li>
          ...
          <li className="propuestas-27">Legislación</li>
...
prevenir el caos y <p></p>la violencia en todas sus formas, eso incluye proteger la vida e 
integridad de los ciudadanos ante todo tipo de amenazas<p></p> como la delincuencia, el 
...
desarrollo, sobre la seguridad. Los ciudadanos deben <p></p>sentirse libres y seguros de 
abrir un negocio, de comerciar con tranquilidad.<p></p> A mayor escala, si el Estado no 
garantiza la seguridad, esto<p></p> también genera efectos en la Inversión Extranjera 
...
de los ciudadanos, incluyendo el derecho a<p></p> la vida, integridad personal, libertad y 
seguridad.</p>
        </section>
...
manera emergente, <p></p>sino de manera permanente las cabezas de cada uno de los poderes 
del  Estado,  para  mantener  activas  decisiones  y  seguimiento  que  atañen  a  todos  en 
conjunto como estado, por encima de las funciones específicas de cada uno.  
 
En este sentido el Palacio de Carondelet, ya no será más el palacio de reuniones del 
presidente y sus ministros,<p></p> sino el centro del ejercicio del seguimiento continuo de la 
responsabilidad del Estado, por parte de todos sus poderes.  
 
Las reuniones del Consejo de Estado serán objeto del libre acceso por parte de toda la 
ciudadanía a través de los mecanismos de gobierno electrónico. Las únicas reuniones del 
...
los puestos de decisión institucionales sólo puedan ser ocupados por servidores de carrera, 
de alto desempeño y reconocida honradez, de cada una de esas entidades de control.  
 
Pero más allá de la promoción<p></p>de reformas legales o eventuales reformas constitucionales 
necesarias para acceder a estos objetivos, propondremos una campaña de sinceramiento 
y transparencia de la actual condición de los procesos de control que, sólo reflejan una 
estadística muerta, en la que se esconde la impunidad de servidores públicos que por 
omisión de acciones de control oportunas y eficaces, han dejado de ser, en el tiempo, 
verdaderos sujetos de control y fiscalización.  
 
Las reformas propuestas están encaminadas a eliminar los trámites caducados represados 
en el sistema de control que, sólo sirve en la práctica para entorpecer el despacho de las 
causas activas y sobre las cuales aún caben acciones concurrentes o “ex post” dentro del 
sistema de control estatal de la Contraloría General del Estado.  
 
El  proceso  de  transparentar,<p></p>  sobre  todas  las  notificaciones  de  predeterminación  de 
responsabilidades civiles culposas y administrativas y órdenes de reintegro sobre las que 
hubieren  transcurrido  más  de  siete  años  previstos  legalmente  y  que  no  hayan  sido 
notificadas con larespectiva resolución permitirá a la Contraloría General del Estado 
incrementar la velocidad de procesos en las causas más recientes y que constituyen el 
porcentaje más alto de perjuicios ocasionados al Estado que, se mantienen incobrables 
sólo a causa del número de causas represadas y sin despacho.
