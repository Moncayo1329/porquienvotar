    ...
    <div>
      ...
      <div className="Propuestas">
        ...
        <li className="propuestas-3">Económico</li>
          ...
          <li className="propuestas-28">Gestión</li>
        </ul>
      </div>
...
presidente y sus ministros, sino el centro del ejercicio del seguimiento continuo de la 
...
Consejo de Estado que tendrán carácter de reservadas serán aquellas que hagan relación 
...
conformadas en conjunto por todos los poderes del Estado, a partir de mecanismos de 
...
Pero más allá de la promoción de reformas legales o eventuales reformas constitucionales 
...
El  proceso  de  transparentar,  sobre  todas  las  notificaciones  de  predeterminación  de 
...
notificadas con la respectiva resolución permitirá a la Contraloría General del Estado 
