		...
		<>
			...
			<div className="container mt-5 pb-5">
				...
				y creo que es muy importante estar informado de lo que votamos  y de esa manera tener una mejor elección de nuestras autoridades.
			      está diseñado para estar libre de información errónea y ser un trampolín para el aprendizaje futuro.<br></br> Quiero  agradecer a Martin Machado, Anahi Parraga, Romina Sanchez, Jorge baldeon y mi primo Pablo Andrés León por su feedback y su apoyo. También a las personas que están utilizando la website. </p>
